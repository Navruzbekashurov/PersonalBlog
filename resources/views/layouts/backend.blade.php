            ...
            <ul class="nav-main">
              ...
              <li class="nav-main-item{{ request()->is('pages/*') ? ' open' : '' }}">
                ...
                <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                    <a class="nav-main-link{{ request()->is('/articles/create') ? ' active' : '' }}" href="/articles/create">
                      <span class="nav-main-link-name">Create</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link{{ request()->is('myarticle') ? ' active' : '' }}" href="/myarticle">
                      <span class="nav-main-link-name">My Articles</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                  ...
                  <i class="nav-main-link-icon fa fa-globe"></i>
                    <li class="nav-main-item">
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="nav-main-link btn btn-link p-0 m-0 align-baseline">
